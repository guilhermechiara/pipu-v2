...
import { CreateCycleForm } from "../../../../features/cycles/forms/create/CreateCycleForm";
    ...
    <PageContainer>
      <PageHeader>
        ...
        <PageHeaderDescription>
          ...
          ocorrer quantas vezes a empresa determinar ao longo do ano, de acordo
          com as determinações do RH.
        </PageHeaderDescription>
      </PageHeader>
      <PageContent>
        <CreateCycleForm />
