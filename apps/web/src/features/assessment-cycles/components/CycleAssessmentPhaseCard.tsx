...
import { CycleAssessmentRadialChart } from "./CycleAssessmentRadialChart";
import { CycleAssessmentConclusionWarning } from "./CycleAssessmentConclusionWarning";
...
interface CyclePhaseCardProps {
  ...
  control: Control<AssessmentCycleFormValues>;
  minDatePicker: Date;
  maxDatePicker: Date;
  ...
  return (
    <OutlineCard type="cyan" className={cardClassName}>
      <OutlineCardContent className="flex flex-col gap-4">
        ...
        <CycleAssessmentConclusionWarning
          phase={warningPhaseName}
          endDate={endDate}
        />
      </OutlineCardContent>
    </OutlineCard>
