...
const NewAssessmentCycleFormReviewCard = React.forwardRef<
  HTMLDivElement,
...
NewAssessmentCycleFormReviewCard.displayName =
  "NewAssessmentCycleFormReviewCard";

const NewAssessmentCycleFormStepReview = ({ form }: StepProps) => {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        <NewAssessmentCycleFormReviewCard className="flex flex-row gap-8">
...
export { NewAssessmentCycleFormStepReview };
