...
import {
  AssessmentCycleFormValues,
  DEFAULT_ASSESSMENT_CYCLE_MAX_DATES,
  DEFAULT_ASSESSMENT_CYCLE_MIN_DATES,
  useAssessmentCycleForm,
} from "../../hooks/useAssessmentCycleForm";
...
import { CyclePhaseCard } from "../CycleAssessmentPhaseCard";
...
const EditAssessmentCycleForm = ({ id }: EditAssessmentCycleFormProps) => {
  const { data: cycle } = useAssessmentCycle(id);

  const { schema: editAssessmentCycleFormSchema } = useAssessmentCycleForm();
  const form = useForm<AssessmentCycleFormValues>({
  ...
  const phases: Array<{
  ...
  }> = [
    {
      ...
      fields: {
        StartDateComponent: AssessmentCycleDatesFormField.StartDate,
        EndDateComponent: AssessmentCycleDatesFormField.EndDate,
      },
    ...
    },
    {
      ...
      fields: {
        StartDateComponent: AssessmentCycleDatesFormField.AdjustmentStartDate,
        EndDateComponent: AssessmentCycleDatesFormField.AdjustmentEndDate,
      },
    ...
    },
    {
      ...
      fields: {
        StartDateComponent: AssessmentCycleDatesFormField.ShareStartDate,
        EndDateComponent: AssessmentCycleDatesFormField.ShareEndDate,
      },
  ...
  function onSubmit(data: AssessmentCycleFormValues) {
    mutate({
      cycleDates: {
...
export { EditAssessmentCycleForm };
