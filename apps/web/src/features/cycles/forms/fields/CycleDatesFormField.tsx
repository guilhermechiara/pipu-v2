import { CycleDatePickerFormField } from "./CycleDatePickerFormField";
import { Control, FieldValues } from "react-hook-form";
import { ScheduleCycleFormValues } from "../schedule/useScheduleCycleForm";

interface AssessmentCycleDatesFormFieldProps<
  TFormValues extends ScheduleCycleFormValues,
> {
  minDatePicker: Date;
  maxDatePicker: Date;
...
const AssessmentCycleStartDateFormField = <TFormValues extends FieldValues>({
  ...
  maxDatePicker,
  control,
}: AssessmentCycleDatesFormFieldProps<ScheduleCycleFormValues>) => (
  <CycleDatePickerFormField
...
export const CycleDatesFormField = {
